  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream">
      <main className="flex-1 w-full">
        <div className="mx-auto max-w-3xl w-full px-4 py-12 md:py-20">
          ...
          <div className="mt-8 space-y-5 text-ink/80 text-base md:text-lg leading-relaxed">
            <p>
              <T>Zorba Rentals is a professionally managed guest house operation offering furnished monthly rooms across three friendly properties in Aylmer-Gatineau, Quebec — just a 15-minute direct bus to downtown Ottawa.</T>
            </p>
            <p>
